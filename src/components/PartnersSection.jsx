...
export const PartnersSection = () => {
    ...
    return (
        <section id="partners" className="partners-section py-20 bg-mint border-b border-primary/10 select-none overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 text-center">

                <h2 className="font-sans font-bold text-[32px] sm:text-[42px] tracking-tight text-dark max-w-2xl mx-auto leading-tight mb-10">
                        ...
                        <button
                            ...
                            className={`
                                ...
                                ${activeTab === tab.id
                                    ...
                                    : 'bg-white border-primary/20 text-slate-700 hover:border-primary/40 hover:bg-primary/5'
                                }
                            `}
                        >
                            {tab.label}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 max-w-4xl mx-auto justify-center items-center">
                    {filteredPartners.map((partner, index) => (
                        <div
                            key={`${activeTab}-${index}`}
                            className="bg-white border border-primary/10 h-28 rounded-xl flex items-center justify-center shadow-sm hover:scale-[1.02] hover:shadow-md transition-all duration-300 group cursor-pointer relative overflow-hidden animate-fadeIn"
                        >
                            <img
                                src={partner.logoSrc}
                                alt="Partner Logo"
